            ...
            <form>
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  rows={5}
                  defaultValue={
                    "4C hair has the tightest curls of all hair patterns, with hairs forming tight coils. 4C hair shares many of the other characteristics of type 4 hair, and of course, individuals with 4C hair can have different hair densities and porosities, which changes how your hair behaves."
                  }
                />
              </div>
              <Link
